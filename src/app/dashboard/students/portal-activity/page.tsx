...
interface BulkSummary {
  ...
  alreadyActive: number; staffConflict: number; familyConflict: number; notPrincipal: number; errors: number; total: number;
}
            ...
            <div className="card border-green-700/40 bg-green-900/10 space-y-3">
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 gap-2 text-center">
                {[
                  ...
                  { label: "No es principal",     value: bulkResult.summary.notPrincipal, color: "text-orange-400" },
                    ...
                    <div key={r.studentId}
                      ...
                      <span className="shrink-0">
                        {r.status === "activated"            ? (r.emailSent ? "✅" : "⚠️") :
                         ...
                         r.status === "skipped_not_principal"   ? "👑" : "❌"}
                      </span>
                      ...
                      <span className="text-dojo-muted truncate max-w-[160px]">
                        {r.status === "activated"
                          ...
                          : r.status === "skipped_not_principal"
                          ? (r.errorDetail ?? "solo el familiar principal puede tener acceso")
                          : r.errorDetail ?? "error"}
                      </span>
                    </div>
                  ))}
